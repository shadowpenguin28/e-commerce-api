...
class Cart(models.Model):
    ...
    created_at = models.DateTimeField(
        auto_now_add=True,
        help_text="When cart was first created"
    )
...
class CartItem(models.Model):
    ...
    quantity = models.IntegerField(
        ...
        help_text="Quantity of item in cart"
    )
    ...
    updated_at = models.DateTimeField(
        auto_now=True,
        help_text="When cart item was last updated"
    )
    ...
    def clean(self):
        ...
        if self.quantity > self.item.quantity:
            raise ValidationError(
                f"Only {self.item.quantity} items available in stock"
            )
...
class WishList(models.Model):
    """
    Optional: User wishlist for items they want to buy later
    Similar to cart but for saving items for future purchase
    """
...
class WishListItem(models.Model):
    ...
    def __str__(self):
        return f"{self.item.name} in {self.wishlist.user.username}'s wishlist"
